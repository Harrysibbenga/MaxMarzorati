  ...
  <div>
    ...
    <mdb-modal size="md" :show="uploadVideo" @close="closeVideoUpload">
      ...
      <mdb-modal-body>
        <div class="row">
          <div class="col-12">
            <div class="md-form">
              <mdb-input label="Description" inline v-model.trim="video.alt" />
            </div>
          </div>
          <div class="col-12">
    ...
    <mdb-modal
        ...
        <mdb-modal-footer>
            ...
            <mdb-btn color="primary" @click="updateContent">Confirm</mdb-btn>
        </mdb-modal-footer>
        </mdb-modal>
  </div>
</template>
...
import { videoCollection, videoSection } from "../../../firebase";
import {
  mdbInput,
  mdbBtn,
  mdbContainer,
...
export default {
  ...
  computed: {
    videoContent() {
      return this.$store.getters["videoSection/getVideo"];
    },
    videoList() {
