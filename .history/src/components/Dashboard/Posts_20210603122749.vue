<template>
  <div>
    <div class="custom-control custom-switch">
      ...
      <label class="custom-control-label" for="customSwitches" v-model="switch">Change news display image ?</label>
    </div>
    <mdb-container v-if="switch">
      <image-upload :image="head"></image-upload>
      <mdb-btn color="primary" @click="save">Update image</mdb-btn>
    </mdb-container>
    <mdb-container>
      <mdb-row>
